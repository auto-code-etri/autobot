...
// Get Autobot version from package.json at build time
...
class ClawRouter extends OpenAI {
  ...
  /**
   * Override headers to include Autobot-specific User-Agent
   * This helps ClawRouter track integration usage and optimize accordingly
   */
  protected _getHeaders() {
    return {
      ...super._getHeaders(),
      "User-Agent": `Autobot/${CONTINUE_VERSION}`,
      "X-Autobot-Provider": "clawrouter",
    };
  }
}
