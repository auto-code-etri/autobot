...
If any of these tools are unavailable, inform the user that they need to activate them and enable "Agent Mode" in Autobot before proceeding.
...
3. Explain that Autobot will automatically load this file into context when working with the project
